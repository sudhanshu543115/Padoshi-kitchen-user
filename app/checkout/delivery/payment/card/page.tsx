    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md">
        ...
        <input
          ...
          className="w-full border placeholder-gray-600 text-black border-slate-200 rounded-xl px-4 py-3 mb-4"
        />
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          <input
            type="text"
            placeholder="MM / YY"
            className="border border-slate-200 placeholder-gray-600 text-black rounded-xl px-4 py-3"
          />
          <input
            type="password"
            placeholder="CVV"
