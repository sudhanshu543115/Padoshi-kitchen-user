                  ...
                  <div className="flex-1 flex flex-col">
                    ...
                    {item.addons?.length > 0 && (
                      <div className="mt-3 pt-2">
                         <details className="group/addons">
                           <summary className="text-[10px] font-bold uppercase tracking-widest text-slate-400 cursor-pointer hover:text-orange-500 transition-colors list-none flex items-center gap-1">
                              View Add-ons <span className="group-open/addons:rotate-180 transition-transform">▼</span>
                           </summary>
                           <div className="flex flex-wrap gap-2 mt-2 animate-in slide-in-from-top-2 fade-in duration-200">
                             {item.addons.map((addon: any) => (
                               <div key={addon._id} className="text-xs px-2 py-1 bg-slate-50 text-slate-600 rounded border border-slate-100">
                                 {addon.name} <span className="font-semibold text-slate-800">+₹{addon.price}</span>
                               </div>
                             ))}
                           </div>
                         </details>
